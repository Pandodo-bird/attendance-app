...
function DashboardContent() {
  ...
  return (
    <div className={`min-h-screen bg-gradient-to-br ${theme.lightBg} dark:from-gray-900 dark:via-gray-900 dark:to-gray-900 transition-colors duration-300`}>
      {/* Theme Toggle */}
      <button
        onClick={toggleTheme}
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="bg-gradient-to-r from-red-500 to-rose-600 text-white px-4 py-2 rounded-lg hover:from-red-600 hover:to-rose-700 transition text-sm font-medium shadow-md"
              >
                Logout
              </button>
            </div>
          ...
          {isTeacher ? (
            ...
            <>
              <div className={`bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 border ${theme.border} ${theme.darkBorder} transition-colors duration-300 hover:shadow-xl`}>
                ...
                <button className={`w-full py-2 px-4 rounded-lg bg-gradient-to-r ${theme.gradient} text-white font-medium hover:opacity-90 transition`}>
                  Manage Sections
                </button>
              </div>
